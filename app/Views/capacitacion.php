...
<head>
    ...
    <?php
                        ...
                        if($user->get('nombre_usuario')==""){
                            ...
                            if($user->get('rol')==1){
                                echo '<title>Encargado - Capacitación</title>';
                            }else{
                                if($user->get('rol')==0){
                                    echo '<title>administrador - Capacitación</title>';
                                }
                            }
                        }
                ...
                <div class="col-lg-12">
                    ...
                    <div class="float-right">
                        ...
                        <div class="dropdown dib">
                            ...
                            <h1 class="h3 mb-2 text-gray-800">Tabla de capacitación</h1>
                        </div>
                        </div>
                        </div>
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary" style="font-size:120%;">Lista de capacitación</h6><br>
        <a href="<?= base_url('registro_capacitacion'); ?>" class="btn btn-primary">Registrar nueva capacitación</a><br>
    </div>
    <div class="card-body">
  ...
  <div class="toast-body" style="margin-left:40%;"><?= session('success') ?></div>
     ...
     <tr>
       ...
       <th>Eliminar</th>
        ...
        <?php foreach ($capacitacion as $capacitaciones):?>
     <tr>
     <tr>
       <td><?= $capacitaciones['id_capacitacion']; ?></td>
       <td><?= $capacitaciones['nombre_capacitacion']; ?></td>
       <td><?= $capacitaciones['duracion_capacitacion']; ?></td>

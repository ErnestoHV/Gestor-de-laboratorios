...
<head>
    ...
    <?php
                        ...
                        if($user->get('nombre_usuario')==""){
                            ...
                            if($user->get('rol')==1){
                                echo '<title>Encargado - Capacitación y Equipos</title>';
                            }else{
                                if($user->get('rol')==0){
                                    echo '<title>administrador - Capacitación y Equipos</title>';
                                }
                            }
                        }
                ...
                <div class="col-lg-12">
                    ...
                    <div class="float-right">
                        ...
                        <div class="dropdown dib">
                            ...
                            <h1 class="h3 mb-2 text-gray-800">Tabla de capacitaciones y equipos</h1>
                        </div>
                        </div>
                        </div>
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary" style="font-size:120%;">Lista de capacitación y equipos</h6><br>
        <a href="<?= base_url('registro_cap_equipos'); ?>" class="btn btn-primary">Registrar nuevo equipo</a><br>
    </div>
    <div class="card-body">
  ...
  <div class="toast-body" style="margin-left:40%;"><?= session('success') ?></div>
     ...
     <tr>
       ...
       <th>Eliminar</th>
        ...
        <?php foreach ($equipos_capacitacion as $indice1 => $equipos_capacitaciones):?>
                <?php foreach ($general as $indice2 => $generales):?>
                   <?php if($indice1 == $indice2):?> 
     <tr>
     <tr>
     <tr>
       <td><?= $equipos_capacitaciones['id_equipo_capacitacion']; ?></td>
       <td><?= $equipos_capacitaciones['id_equipo'].". ".$generales->nombre_equipo; ?></td>
       <td><?= $equipos_capacitaciones['id_capacitacion'].". ".$generales->nombre_capacitacion; ?></td>
       <td><a href="<?php echo base_url('modificar_cap_equipos');?>"data-toggle="modal" data-target="#modalEditarCap_equipos<?php echo $equipos_capacitaciones['id_equipo_capacitacion'];?>"><i class="fa-solid fa-pencil" style="color: #1a8fc1;"></i></a></td>
       <td><a href="<?= base_url('Cap_equiposModel/eliminar/'.$equipos_capacitaciones['id_equipo_capacitacion'])?>" onclick="return confirm('¿Está seguro que desea borrar este registro?')"><i class="fa-solid fa-trash-can" style="color: #db0000;"></i></a></td>
     </tr>
     <?php include('modificar_cap_equipos.php')?>
     <?php endif; ?>
     <?php endforeach; ?>
    <?php endforeach; ?>
    </tr>

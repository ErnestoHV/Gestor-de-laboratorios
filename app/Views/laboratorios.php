...
<head>
    ...
    <?php
                        ...
                        if($user->get('nombre_usuario')==""){
                            ...
                            if($user->get('rol')==1){
                                echo '<title>Encargado - Laboratorios</title>';
                            }else{
                                if($user->get('rol')==0){
                                    echo '<title>administrador - Laboratorios</title>';
                                }
                            }
                        }
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary" style="font-size:120%;">Lista de laboratorios</h6><br>
        <a href="<?= base_url('registro_lab'); ?>" class="btn btn-primary text-light text-bold">Registrar nuevo laboratorio</a><br>
    </div>
  ...
  <div class="toast-body" style="margin-left:40%;"><?= session('success') ?></div>
     ...
     <?php
      ...
      ?>
     <tr>
       <td><?= $laboratorios['id_laboratorio']; ?></td>
       <td><?= $laboratorios['nombre_laboratorio']; ?></td>
       <td><?= $laboratorios['ubicacion_laboratorio']; ?></td>
       <td><?= $laboratorios['nombre_responsable']; ?></td>
       <td><?= $laboratorios['observacion_laboratorio']; ?></td>

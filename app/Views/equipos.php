...
<head>
    ...
    <?php
                        ...
                        if($user->get('nombre_usuario')==""){
                            ...
                            if($user->get('rol')==1){
                                echo '<title>Encargado - Equipos</title>';
                            }else{
                                if($user->get('rol')==0){
                                    echo '<title>administrador - Equipos</title>';
                                }
                            }
                        }
                ...
                <div class="col-lg-12">
                    ...
                    <div class="float-right">
                        ...
                        <div class="dropdown dib">
                            ...
                            <h1 class="h3 mb-2 text-gray-800">Tabla de equipos</h1>
                        </div>
                        </div>
                        </div>
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary" style="font-size:120%;">Lista de equipos</h6><br>
        <a href="<?= base_url('registro_equipos'); ?>" class="btn btn-primary">Registrar nuevo equipo</a><br>
    </div>
    <div class="card-body">
  ...
  <div class="toast-body" style="margin-left:40%;"><?= session('success') ?></div>
     ...
     <tr>
       ...
       <th>Eliminar</th>
        ...
        <?php foreach ($equipo as $indice1 => $equipos):?>
        <?php foreach ($lab as $indice2 => $labs):?>
           <?php if($indice1 == $indice2):?>  
     <tr>
     <tr>
       <td><?= $equipos['id_equipo']; ?></td>
       <td><?= $equipos['nombre_equipo']; ?></td>
       <td><?= $equipos['marca_equipo']; ?></td>
       <td><?= $equipos['modelo_equipo']; ?></td>
       <td><?= $equipos['tipo_equipo']; ?></td>
       <td><?= $equipos['descripcion_equipo']; ?></td>
       <td><?= $equipos['riesgo_equipo']; ?></td>
       <td><?= $equipos['id_laboratorio'].". ".$labs->nombre_laboratorio; ?></td>
       <td><a href="<?php echo base_url('modificar');?>"data-toggle="modal" data-target="#modalEditarEquipo<?php echo $equipos['id_equipo'];?>"><i class="fa-solid fa-pencil" style="color: #1a8fc1;"></i></a></td>
       <td><a href="<?= base_url('EquiposModel/eliminar/'.$equipos['id_equipo'])?>" onclick="return confirm('¿Está seguro que desea borrar este equipo?')"><i class="fa-solid fa-trash-can" style="color: #db0000;"></i></a></td>
     </tr>
     <?php include('modificar_eq.php')?>
     <?php endif; ?>
     <?php endforeach; ?>
    <?php endforeach; ?>
     </table>
